...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <form class="card p-2">
                <p><b>АИУС</b> - автоматизировансПорядок действий должен быть максимально удобен, вопросы должны быть
            ...
            <form class="needs-validation" novalidate>
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input class="form-control" id="incidentNumber" placeholder="" required type="search" value="">
                    </div>
...
<%--                            %>--%>
            ...
            </form><form action="manager" method="get"><div class="col-md-4 mb-3">
            <label for="incidentNumber">Номер</label>
            <input class="form-control" id="id" placeholder="" required type="search" name="id" value="">
        </div><button class="btn btn-primary btn-lg" type="submit"></button></form>
        </div>
    </div>
    <hr>
